...
/* harmony import */ var _chart_chart_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chart/chart.component */ "./src/app/admin/chart/chart.component.ts");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | product-product-module */[__webpack_require__.e("common"), __webpack_require__.e("product-product-module")]).then(__webpack_require__.bind(null, /*! ./product/product.module */ "./src/app/admin/product/product.module.ts")).then(module => module.ProductModule)
    },
    {
        path: 'category',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => __webpack_require__.e(/*! import() | category-category-module */ "category-category-module").then(__webpack_require__.bind(null, /*! ./category/category.module */ "./src/app/admin/category/category.module.ts")).then(module => module.CategoryModule)
    },
    {
        path: 'warehouse',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | warehouse-warehouse-module */[__webpack_require__.e("common"), __webpack_require__.e("warehouse-warehouse-module")]).then(__webpack_require__.bind(null, /*! ./warehouse/warehouse.module */ "./src/app/admin/warehouse/warehouse.module.ts")).then(module => module.WarehouseModule)
    },
    {
        path: 'warehouse-bill',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | warehouse-bill-warehouse-bill-module */[__webpack_require__.e("common"), __webpack_require__.e("warehouse-bill-warehouse-bill-module")]).then(__webpack_require__.bind(null, /*! ./warehouse-bill/warehouse-bill.module */ "./src/app/admin/warehouse-bill/warehouse-bill.module.ts")).then(module => module.WarehouseBillModule)
    },
    {
        path: 'orders',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | orders-orders-module */[__webpack_require__.e("common"), __webpack_require__.e("orders-orders-module")]).then(__webpack_require__.bind(null, /*! ./orders/orders.module */ "./src/app/admin/orders/orders.module.ts")).then(module => module.OrdersModule)
    },
    {
        path: 'messenger',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | admin-chat-admin-chat-module */[__webpack_require__.e("common"), __webpack_require__.e("admin-chat-admin-chat-module")]).then(__webpack_require__.bind(null, /*! ./admin-chat/admin-chat.module */ "./src/app/admin/admin-chat/admin-chat.module.ts")).then(module => module.AdminChatModule)
    },
    {
        path: 'bills',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | bill-bill-module */[__webpack_require__.e("common"), __webpack_require__.e("bill-bill-module")]).then(__webpack_require__.bind(null, /*! ./bill/bill.module */ "./src/app/admin/bill/bill.module.ts")).then(module => module.BillModule)
    },
    {
        path: 'users',
        canActivateChild: [_helper_admin_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AdminAuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | user-user-module */[__webpack_require__.e("common"), __webpack_require__.e("user-user-module")]).then(__webpack_require__.bind(null, /*! ./user/user.module */ "./src/app/admin/user/user.module.ts")).then(module => module.UserModule)
    }
];
...
/* harmony import */ var _chart_chart_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chart/chart.component */ "./src/app/admin/chart/chart.component.ts");
...
ChartComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-admin',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chart.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/admin/chart/chart.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chart.component.scss */ "./src/app/admin/chart/chart.component.scss")).default]
    })
], ChartComponent);
